...
const UUID = process.env.UUID || '7d9d97ab-7b87-4afe-b68e-6be97dd7995e'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'pella1.712888.xyz';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMGE0N2ExYTkxYjY4MTMwNzhjOWFiYTQ3YzJkMGU1NTIiLCJ0IjoiZWMzYTZmMzktMzUyMy00OGU3LTkxMzctM2I0ZWVjNGZhYzQzIiwicyI6Illqa3hNelZoT0RrdE1HUTFNQzAwTkRBMExXSXdObVF0Wm1NMFlUY3paVFpoTkdReSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
...
const CHAT_ID = process.env.CHAT_ID || '7112239809';                  // Telegram chat_id  两个变量不全不推送节点到TG 
const BOT_TOKEN = process.env.BOT_TOKEN || '8434978786:AAFjR77_XIfLzSGwCQ1y-B6XhKi5iBRvNng';              // Telegram bot_token 两个变量不全不推送节点到TG 
